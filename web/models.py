...
class Item(models.Model):
    ...
    volume_2 = models.CharField(max_length=100, verbose_name='Объем/Вес', blank=True)
    price_2 = models.FloatField(verbose_name='Цена', blank=True)
    ...
    def get_absolute_url(self):
        return reverse('product_detail', kwargs={'item_slug': self.slug})
